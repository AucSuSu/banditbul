...
class _SearchPageState extends State<SearchPage> {
  ...
  static List<Widget> _pages = <Widget>[
    ...
    SearchTextPage(), // Text Search 페이지
  ];
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          backgroundColor: Colors.white, // 홈 버튼의 배경 색
        ),
      ),
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomAppBar(
          shape: CircularNotchedRectangle(), // 중앙에 노치를 만들기
          notchMargin: 25.0,
          color: Color(0xffF1FFCA), // BottomAppBar의 배경 색
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: List.generate(_pages.length + 1, (index) {
              if (index == 1) {
                // 중앙 홈 버튼 위치에는 공간을 만들어둡니다.
                return SizedBox(width: 100); // FloatingActionButton의 공간을 만듭니다.
              }
